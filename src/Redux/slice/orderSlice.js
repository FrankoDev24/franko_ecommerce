...
const orderSlice = createSlice({
  ...
  reducers: {
    ...
    clearOrders: (state) => {
      ...
      state.loading = { orders: false, lifeCycle: false, deliveryAddress: false, deliveryUpdate: false };
      state.error = { orders: null, lifeCycle: null, deliveryAddress: null, deliveryUpdate: null };
    },
  },
