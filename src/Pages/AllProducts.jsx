  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      ...
      <Helmet>
        ...
        <meta property="og:description" content="Browse and shop the best products at Franko Trading Ltd. Discover amazing deals and new arrivals with a variety of options to choose from." />
