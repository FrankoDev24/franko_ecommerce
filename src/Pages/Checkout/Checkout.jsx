...
import { notification, Card, List, Button, Checkbox, Spin, Modal } from "antd";
...
const CheckoutPage = () => {
    ...
    try {
      const orderResponse = await dispatch(
        checkOutOrder({
          cartId,
          customerId,
          orderId,          // Use this for OrderCode
          address,
          geoLocation,
          paymentMethod,
        })
      ...
      // After successful checkout, dispatch order address with required params
      await dispatch(
        orderAddress({
          address,
          customerId,
          OrderCode: orderId, // Include orderId as OrderCode
          GeoLocation: geoLocation, // Include geoLocation
        })
      );
  ...
  const handleSuccessModalClose = () => {
    ...
    navigate("/franko"); // Redirect to homepage or desired route after order success
  };
